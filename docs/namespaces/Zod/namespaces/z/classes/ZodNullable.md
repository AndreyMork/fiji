...
[@ayka/fiji](../../../../../globals.md) / [Zod](../../../README.md) / [z](../README.md) / ZodNullable

# Class: ZodNullable\<T\>

## Extends

- `ZodType`\<`T`\[`"_output"`\] \| `null`, [`ZodNullableDef`](../interfaces/ZodNullableDef.md)\<`T`\>, `T`\[`"_input"`\] \| `null`\>
...
> `readonly` **\_def**: [`ZodNullableDef`](../interfaces/ZodNullableDef.md)\<`T`\>
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../type-aliases/SafeParseReturnType.md)\<`null` \| `T`\[`"_input"`\], `null` \| `T`\[`"_output"`\]\>\>
...
> **\_parse**(`input`): [`ParseReturnType`](../type-aliases/ParseReturnType.md)\<`null` \| `T`\[`"_output"`\]\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../type-aliases/AsyncParseReturnType.md)\<`null` \| `T`\[`"_output"`\]\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../type-aliases/SyncParseReturnType.md)\<`null` \| `T`\[`"_output"`\]\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../type-aliases/SafeParseReturnType.md)\<`null` \| `T`\[`"_input"`\], `null` \| `T`\[`"_output"`\]\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../type-aliases/SafeParseReturnType.md)\<`null` \| `T`\[`"_input"`\], `null` \| `T`\[`"_output"`\]\>\>
