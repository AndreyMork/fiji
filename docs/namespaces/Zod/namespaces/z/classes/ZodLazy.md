...
[@ayka/fiji](../../../../../globals.md) / [Zod](../../../README.md) / [z](../README.md) / ZodLazy

# Class: ZodLazy\<T\>

## Extends

- `ZodType`\<[`output`](../type-aliases/output.md)\<`T`\>, [`ZodLazyDef`](../interfaces/ZodLazyDef.md)\<`T`\>, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **\_refinement**(`refinement`): `ZodEffects`\<`ZodLazy`\<`T`\>, [`output`](../type-aliases/output.md)\<`T`\>, [`input`](../type-aliases/input.md)\<`T`\>\>
...
`ZodEffects`\<`ZodLazy`\<`T`\>, [`output`](../type-aliases/output.md)\<`T`\>, [`input`](../type-aliases/input.md)\<`T`\>\>
...
• **def**: `noUndefined`\<[`input`](../type-aliases/input.md)\<`T`\>\>
...
> **refine**\<`RefinedOutput`\>(`check`, `message`?): `ZodEffects`\<`ZodLazy`\<`T`\>, `RefinedOutput`, [`input`](../type-aliases/input.md)\<`T`\>\>
...
`ZodEffects`\<`ZodLazy`\<`T`\>, `RefinedOutput`, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **refine**(`check`, `message`?): `ZodEffects`\<`ZodLazy`\<`T`\>, [`output`](../type-aliases/output.md)\<`T`\>, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **refinement**\<`RefinedOutput`\>(`check`, `refinementData`): `ZodEffects`\<`ZodLazy`\<`T`\>, `RefinedOutput`, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **refinement**(`check`, `refinementData`): `ZodEffects`\<`ZodLazy`\<`T`\>, [`output`](../type-aliases/output.md)\<`T`\>, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **superRefine**\<`RefinedOutput`\>(`refinement`): `ZodEffects`\<`ZodLazy`\<`T`\>, `RefinedOutput`, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **superRefine**(`refinement`): `ZodEffects`\<`ZodLazy`\<`T`\>, [`output`](../type-aliases/output.md)\<`T`\>, [`input`](../type-aliases/input.md)\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): `ZodEffects`\<`ZodLazy`\<`T`\>, `NewOut`, [`input`](../type-aliases/input.md)\<`T`\>\>
...
`ZodEffects`\<`ZodLazy`\<`T`\>, `NewOut`, [`input`](../type-aliases/input.md)\<`T`\>\>
