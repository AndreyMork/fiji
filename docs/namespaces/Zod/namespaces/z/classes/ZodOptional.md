...
[@ayka/fiji](../../../../../globals.md) / [Zod](../../../README.md) / [z](../README.md) / ZodOptional

# Class: ZodOptional\<T\>

## Extends

- `ZodType`\<`T`\[`"_output"`\] \| `undefined`, [`ZodOptionalDef`](../interfaces/ZodOptionalDef.md)\<`T`\>, `T`\[`"_input"`\] \| `undefined`\>
