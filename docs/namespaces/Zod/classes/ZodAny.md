...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodAny

# Class: ZodAny

## Extends

- `ZodType`\<`any`, [`ZodAnyDef`](../namespaces/z/interfaces/ZodAnyDef.md), `any`\>
...
• **def**: [`ZodAnyDef`](../namespaces/z/interfaces/ZodAnyDef.md)
...
> `readonly` **\_def**: [`ZodAnyDef`](../namespaces/z/interfaces/ZodAnyDef.md)
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`any`, `any`\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`any`, `any`\>\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`any`\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`any`\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`any`\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`any`, `any`\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`any`, `any`\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`any`, `any`\>\>
