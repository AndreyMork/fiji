...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodUnion

# Class: ZodUnion\<T\>

## Extends

- `ZodType`\<`T`\[`number`\]\[`"_output"`\], [`ZodUnionDef`](../namespaces/z/interfaces/ZodUnionDef.md)\<`T`\>, `T`\[`number`\]\[`"_input"`\]\>

## Type Parameters

• **T** *extends* [`ZodUnionOptions`](../namespaces/z/type-aliases/ZodUnionOptions.md)
...
• **def**: [`ZodUnionDef`](../namespaces/z/interfaces/ZodUnionDef.md)\<`T`\>
...
> `readonly` **\_def**: [`ZodUnionDef`](../namespaces/z/interfaces/ZodUnionDef.md)\<`T`\>
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[`number`\]\[`"_input"`\], `T`\[`number`\]\[`"_output"`\]\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[`number`\]\[`"_input"`\], `T`\[`number`\]\[`"_output"`\]\>\>
...
> `static` **create**: \<`T_1`\>(`types`, `params`?) => `ZodUnion`\<`T_1`\>

#### Type Parameters

• **T_1** *extends* readonly [[`ZodTypeAny`](../namespaces/z/type-aliases/ZodTypeAny.md), [`ZodTypeAny`](../namespaces/z/type-aliases/ZodTypeAny.md), [`ZodTypeAny`](../namespaces/z/type-aliases/ZodTypeAny.md)]
...
> **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`T`\[`number`\]\[`"_output"`\]\>
...
[`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`T`\[`number`\]\[`"_output"`\]\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`T`\[`number`\]\[`"_output"`\]\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`T`\[`number`\]\[`"_output"`\]\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`T`\[`number`\]\[`"_output"`\]\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`T`\[`number`\]\[`"_output"`\]\>
...
`ZodEffects`\<`ZodUnion`\<`T`\>, `T`\[`number`\]\[`"_output"`\], `T`\[`number`\]\[`"_input"`\]\>
...
`ZodOptional`\<`ZodNullable`\<`ZodUnion`\<`T`\>\>\>
...
`ZodEffects`\<`ZodUnion`\<`T`\>, `RefinedOutput`, `T`\[`number`\]\[`"_input"`\]\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[`number`\]\[`"_input"`\], `T`\[`number`\]\[`"_output"`\]\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[`number`\]\[`"_input"`\], `T`\[`number`\]\[`"_output"`\]\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[`number`\]\[`"_input"`\], `T`\[`number`\]\[`"_output"`\]\>\>
...
> **transform**\<`NewOut`\>(`transform`): `ZodEffects`\<`ZodUnion`\<`T`\>, `NewOut`, `T`\[`number`\]\[`"_input"`\]\>
...
`ZodEffects`\<`ZodUnion`\<`T`\>, `NewOut`, `T`\[`number`\]\[`"_input"`\]\>
