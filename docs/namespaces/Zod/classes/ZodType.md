...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodType
...
• **Def** *extends* [`ZodTypeDef`](../namespaces/z/interfaces/ZodTypeDef.md) = [`ZodTypeDef`](../namespaces/z/interfaces/ZodTypeDef.md)
...
> `abstract` **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`Output`\>
