...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodNativeEnum

# Class: ZodNativeEnum\<T\>

## Extends

- `ZodType`\<`T`\[keyof `T`\], [`ZodNativeEnumDef`](../namespaces/z/interfaces/ZodNativeEnumDef.md)\<`T`\>, `T`\[keyof `T`\]\>

## Type Parameters

• **T** *extends* [`EnumLike`](../namespaces/z/type-aliases/EnumLike.md)
...
• **def**: [`ZodNativeEnumDef`](../namespaces/z/interfaces/ZodNativeEnumDef.md)\<`T`\>
...
> `readonly` **\_def**: [`ZodNativeEnumDef`](../namespaces/z/interfaces/ZodNativeEnumDef.md)\<`T`\>
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[keyof `T`\], `T`\[keyof `T`\]\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[keyof `T`\], `T`\[keyof `T`\]\>\>
...
• **T_1** *extends* [`EnumLike`](../namespaces/z/type-aliases/EnumLike.md)
...
> **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`T`\[keyof `T`\]\>
...
[`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`T`\[keyof `T`\]\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`T`\[keyof `T`\]\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`T`\[keyof `T`\]\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`T`\[keyof `T`\]\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`T`\[keyof `T`\]\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[keyof `T`\], `T`\[keyof `T`\]\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[keyof `T`\], `T`\[keyof `T`\]\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`T`\[keyof `T`\], `T`\[keyof `T`\]\>\>
