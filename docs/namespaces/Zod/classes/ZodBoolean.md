...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodBoolean

# Class: ZodBoolean

## Extends

- `ZodType`\<`boolean`, [`ZodBooleanDef`](../namespaces/z/interfaces/ZodBooleanDef.md), `boolean`\>
...
• **def**: [`ZodBooleanDef`](../namespaces/z/interfaces/ZodBooleanDef.md)
...
> `readonly` **\_def**: [`ZodBooleanDef`](../namespaces/z/interfaces/ZodBooleanDef.md)
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`boolean`, `boolean`\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`boolean`, `boolean`\>\>
...
node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:381
...
> **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`boolean`\>
...
[`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`boolean`\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`boolean`\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`boolean`\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`boolean`\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`boolean`\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`boolean`, `boolean`\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`boolean`, `boolean`\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`boolean`, `boolean`\>\>
