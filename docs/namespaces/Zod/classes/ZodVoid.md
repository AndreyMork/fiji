...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodVoid

# Class: ZodVoid

## Extends

- `ZodType`\<`void`, [`ZodVoidDef`](../namespaces/z/interfaces/ZodVoidDef.md), `void`\>
...
• **def**: [`ZodVoidDef`](../namespaces/z/interfaces/ZodVoidDef.md)
...
> `readonly` **\_def**: [`ZodVoidDef`](../namespaces/z/interfaces/ZodVoidDef.md)
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`void`, `void`\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`void`, `void`\>\>
...
> **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`void`\>
...
[`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`void`\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`void`\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`void`\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`void`\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`void`\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`void`, `void`\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`void`, `void`\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`void`, `void`\>\>
