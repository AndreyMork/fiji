...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodNull

# Class: ZodNull

## Extends

- `ZodType`\<`null`, [`ZodNullDef`](../namespaces/z/interfaces/ZodNullDef.md), `null`\>
...
• **def**: [`ZodNullDef`](../namespaces/z/interfaces/ZodNullDef.md)
...
> `readonly` **\_def**: [`ZodNullDef`](../namespaces/z/interfaces/ZodNullDef.md)
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`null`, `null`\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`null`, `null`\>\>
...
node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:442
...
> **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`null`\>
...
[`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`null`\>
...
node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:441

***

### \_parseAsync()

> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`null`\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`null`\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`null`\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`null`\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`null`, `null`\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`null`, `null`\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`null`, `null`\>\>
