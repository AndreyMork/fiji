...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodPromise

# Class: ZodPromise\<T\>

## Extends

- `ZodType`\<`Promise`\<`T`\[`"_output"`\]\>, [`ZodPromiseDef`](../namespaces/z/interfaces/ZodPromiseDef.md)\<`T`\>, `Promise`\<`T`\[`"_input"`\]\>\>
...
• **def**: [`ZodPromiseDef`](../namespaces/z/interfaces/ZodPromiseDef.md)\<`T`\>
...
> `readonly` **\_def**: [`ZodPromiseDef`](../namespaces/z/interfaces/ZodPromiseDef.md)\<`T`\>
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`Promise`\<`T`\[`"_input"`\]\>, `Promise`\<`T`\[`"_output"`\]\>\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`Promise`\<`T`\[`"_input"`\]\>, `Promise`\<`T`\[`"_output"`\]\>\>\>
...
> **\_parse**(`input`): [`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`Promise`\<`T`\[`"_output"`\]\>\>
...
[`ParseReturnType`](../namespaces/z/type-aliases/ParseReturnType.md)\<`Promise`\<`T`\[`"_output"`\]\>\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`Promise`\<`T`\[`"_output"`\]\>\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`Promise`\<`T`\[`"_output"`\]\>\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`Promise`\<`T`\[`"_output"`\]\>\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`Promise`\<`T`\[`"_output"`\]\>\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`Promise`\<`T`\[`"_input"`\]\>, `Promise`\<`T`\[`"_output"`\]\>\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`Promise`\<`T`\[`"_input"`\]\>, `Promise`\<`T`\[`"_output"`\]\>\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`Promise`\<`T`\[`"_input"`\]\>, `Promise`\<`T`\[`"_output"`\]\>\>\>
