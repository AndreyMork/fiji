...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodEffects

# Class: ZodEffects\<T, Output, Input\>

## Extends

- `ZodType`\<`Output`, [`ZodEffectsDef`](../namespaces/z/interfaces/ZodEffectsDef.md)\<`T`\>, `Input`\>

## Type Parameters

• **T** *extends* [`ZodTypeAny`](../namespaces/z/type-aliases/ZodTypeAny.md)

• **Output** = [`output`](../namespaces/z/type-aliases/output.md)\<`T`\>

• **Input** = [`input`](../namespaces/z/type-aliases/input.md)\<`T`\>
...
• **def**: [`ZodEffectsDef`](../namespaces/z/interfaces/ZodEffectsDef.md)\<`T`\>
...
> `readonly` **\_def**: [`ZodEffectsDef`](../namespaces/z/interfaces/ZodEffectsDef.md)\<`T`\>
...
> `static` **create**: \<`I`\>(`schema`, `effect`, `params`?) => `ZodEffects`\<`I`, `I`\[`"_output"`\], [`input`](../namespaces/z/type-aliases/input.md)\<`I`\>\>
...
• **effect**: [`Effect`](../namespaces/z/type-aliases/Effect.md)\<`I`\[`"_output"`\]\>

• **params?**: [`RawCreateParams`](../namespaces/z/type-aliases/RawCreateParams.md)

#### Returns

`ZodEffects`\<`I`, `I`\[`"_output"`\], [`input`](../namespaces/z/type-aliases/input.md)\<`I`\>\>
