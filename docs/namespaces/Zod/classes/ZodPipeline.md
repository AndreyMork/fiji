...
[@ayka/fiji](../../../globals.md) / [Zod](../README.md) / ZodPipeline

# Class: ZodPipeline\<A, B\>

## Extends

- `ZodType`\<`B`\[`"_output"`\], [`ZodPipelineDef`](../namespaces/z/interfaces/ZodPipelineDef.md)\<`A`, `B`\>, `A`\[`"_input"`\]\>

## Type Parameters

• **A** *extends* [`ZodTypeAny`](../namespaces/z/type-aliases/ZodTypeAny.md)

• **B** *extends* [`ZodTypeAny`](../namespaces/z/type-aliases/ZodTypeAny.md)
...
• **def**: [`ZodPipelineDef`](../namespaces/z/interfaces/ZodPipelineDef.md)\<`A`, `B`\>
...
> `readonly` **\_def**: [`ZodPipelineDef`](../namespaces/z/interfaces/ZodPipelineDef.md)\<`A`, `B`\>
...
> **spa**: (`data`, `params`?) => `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`A`\[`"_input"`\], `B`\[`"_output"`\]\>\>
...
`Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`A`\[`"_input"`\], `B`\[`"_output"`\]\>\>
...
> **\_parseAsync**(`input`): [`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`B`\[`"_output"`\]\>
...
[`AsyncParseReturnType`](../namespaces/z/type-aliases/AsyncParseReturnType.md)\<`B`\[`"_output"`\]\>
...
> **\_parseSync**(`input`): [`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`B`\[`"_output"`\]\>
...
[`SyncParseReturnType`](../namespaces/z/type-aliases/SyncParseReturnType.md)\<`B`\[`"_output"`\]\>
...
> **safeParse**(`data`, `params`?): [`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`A`\[`"_input"`\], `B`\[`"_output"`\]\>
...
[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`A`\[`"_input"`\], `B`\[`"_output"`\]\>
...
> **safeParseAsync**(`data`, `params`?): `Promise`\<[`SafeParseReturnType`](../namespaces/z/type-aliases/SafeParseReturnType.md)\<`A`\[`"_input"`\], `B`\[`"_output"`\]\>\>
